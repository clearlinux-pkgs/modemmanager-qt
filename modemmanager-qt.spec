...
Version  : 6.0.0
Release  : 76
URL      : https://download.kde.org/stable/frameworks/6.0/modemmanager-qt-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/modemmanager-qt-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/modemmanager-qt-6.0.0.tar.xz.sig
...
%prep
%setup -q -n modemmanager-qt-6.0.0
cd %{_builddir}/modemmanager-qt-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709314080
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6ModemManagerQt.so.6.0.0
/usr/lib64/libKF6ModemManagerQt.so.6
/usr/lib64/libKF6ModemManagerQt.so.6.0.0
