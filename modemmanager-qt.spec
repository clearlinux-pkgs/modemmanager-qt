...
Version  : 5.49.0
Release  : 1
URL      : https://download.kde.org/stable/frameworks/5.49/modemmanager-qt-5.49.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.49/modemmanager-qt-5.49.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.49/modemmanager-qt-5.49.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: modemmanager-qt-lib
Requires: modemmanager-qt-license
...
Group: Development
Requires: modemmanager-qt-lib
Provides: modemmanager-qt-devel
...
%prep
%setup -q -n modemmanager-qt-5.49.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1535157897
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535157897
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/modemmanager-qt
cp COPYING.LIB %{buildroot}/usr/share/doc/modemmanager-qt/COPYING.LIB
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5ModemManagerQt.so.5.49.0
/usr/lib64/libKF5ModemManagerQt.so.6

%files license
%defattr(-,root,root,-)
/usr/share/doc/modemmanager-qt/COPYING.LIB
