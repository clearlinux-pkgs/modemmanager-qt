...
Version  : 5.101.0
Release  : 58
URL      : https://download.kde.org/stable/frameworks/5.101/modemmanager-qt-5.101.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.101/modemmanager-qt-5.101.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.101/modemmanager-qt-5.101.0.tar.xz.sig
...
%prep
%setup -q -n modemmanager-qt-5.101.0
cd %{_builddir}/modemmanager-qt-5.101.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671043272
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5ModemManagerQt.so.5.101.0
