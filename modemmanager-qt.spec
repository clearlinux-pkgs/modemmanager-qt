...
Source0  : https://download.kde.org/stable/frameworks/5.76/modemmanager-qt-5.76.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.76/modemmanager-qt-5.76.0.tar.xz.sig
...
%prep
%setup -q -n modemmanager-qt-5.76.0
cd %{_builddir}/modemmanager-qt-5.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605430895
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/modemmanager-qt-5.76.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/modemmanager-qt/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5ModemManagerQt.so.5.76.0
