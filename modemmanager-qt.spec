...
Version  : 6.14.0
Release  : 95
URL      : https://download.kde.org/stable/frameworks/6.14/modemmanager-qt-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/modemmanager-qt-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/modemmanager-qt-6.14.0.tar.xz.sig
...
%setup -q -n modemmanager-qt-6.14.0
cd %{_builddir}/modemmanager-qt-6.14.0
pushd ..
cp -a modemmanager-qt-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747161157
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6ModemManagerQt.so.6.14.0
/usr/lib64/libKF6ModemManagerQt.so.6
/usr/lib64/libKF6ModemManagerQt.so.6.14.0
