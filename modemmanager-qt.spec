...
Source0  : https://download.kde.org/stable/frameworks/5.55/modemmanager-qt-5.55.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.55/modemmanager-qt-5.55.0.tar.xz.sig
...
%prep
%setup -q -n modemmanager-qt-5.55.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549731450
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5ModemManagerQt.so.5.55.0
