...
Source0  : https://download.kde.org/stable/frameworks/6.2/modemmanager-qt-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/modemmanager-qt-6.2.0.tar.xz.sig
...
%setup -q -n modemmanager-qt-6.2.0
cd %{_builddir}/modemmanager-qt-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715625348
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6ModemManagerQt.so.6.2.0
/usr/lib64/libKF6ModemManagerQt.so.6
/usr/lib64/libKF6ModemManagerQt.so.6.2.0
